          ...
          <div className="lg:col-span-8 space-y-6">
            <div className="glass-card rounded-2xl p-6 shadow-sm border border-slate-200 relative overflow-hidden">
              ...
              <textarea
                ...
                className="w-full h-64 bg-transparent border-none focus:ring-0 outline-none text-lg resize-none placeholder:text-slate-300 text-slate-900"
              />
              ...
              {isLoading && (
                <div className="absolute inset-0 bg-white/80 flex flex-col items-center justify-center z-10">
                  ...
                  <p className="mt-6 text-indigo-900 font-medium text-center px-4">
            ...
            {/* Audio Player Card */}
            {audioUrl && (
              <div className="glass-card rounded-2xl p-6 shadow-xl border-2 border-indigo-100 bg-indigo-50/30">
